...
function Footer() {
  return (
    <div className='w-100% md:h-[500px] rounded-t-[100px] bg-black'>
        ...
        <div className='md:flex w-full h-[300px] items-center mx-auto justify-center gap-[100px]'>
            <div className='text-white text-center w-[500px]'>
                <h2 className='text-l my-3'>Available on App Store and Google Play</h2>
                <div className='md:flex justify-between w-[500px] my-5 mx-auto items-center'>
